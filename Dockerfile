...
# Could not resolve unknown_registry node: CLIPSetLastLayer (no aux_id provided)
# Could not resolve unknown_registry node: MultiLoRAStack (no aux_id provided)
# Could not resolve unknown_registry node: FaceDetailer (no aux_id provided)
# Could not resolve unknown_registry node: UltralyticsDetectorProvider (no aux_id provided)
# Could not resolve unknown_registry node: SAMLoader (no aux_id provided)
# Could not resolve unknown_registry node: UltralyticsDetectorProvider (no aux_id provided)
# Could not resolve unknown_registry node: mxSeed (no aux_id provided)
# Could not resolve unknown_registry node: ConditioningMultiCombine (no aux_id provided)
